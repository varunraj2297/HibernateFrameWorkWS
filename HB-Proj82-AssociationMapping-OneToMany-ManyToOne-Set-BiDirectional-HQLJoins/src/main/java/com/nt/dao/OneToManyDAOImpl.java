...
public class OneToManyDAOImpl implements OneToManyDAO{
	...
	public void saveDataThroughChild() {
		...
		phone1=new Phones();
		phone1.setPhoneno(8586987456L);
		phone1.setNumberType("personal");
		phone1.setProvider("bsnl");
		phone1.setUser(user);
		
		phone2=new Phones();
		phone2.setPhoneno(8566552236L);
	...
	@Override
	public void loadDataParentToChild() {
		Session ses=null;
		Query query=null;
...
//		query=ses.createQuery("select u.userid,u.uname,u.address,ph.phoneno,ph.provider,ph.numberType from User u left join u.phones ph");
//		query=ses.createQuery("select u.userid,u.uname,u.address,ph.phoneno,ph.provider,ph.numberType from User u right join u.phones ph");
		query=ses.createQuery("select u.userid,u.uname,u.address,ph.phoneno,ph.provider,ph.numberType from User u full join u.phones ph");
	...
	@Override
	public void loadDataChildToParent() {
		Session ses=null;
		Query query=null;
		List<Object[]> list=null;
