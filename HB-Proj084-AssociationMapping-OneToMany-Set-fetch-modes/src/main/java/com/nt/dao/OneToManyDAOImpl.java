...
public class OneToManyDAOImpl implements OneToManyDAO{
	...
	public void saveData() {
		...
		phone1=new Phones();
		phone1.setPhoneno(896562155L);
		phone1.setProvider("kli");
		phone1.setNumberType("gh,n");
		
		phone2=new Phones();
		phone2.setPhoneno(856321455L);
		phone2.setProvider("ert");
		phone2.setNumberType("gfchhb");
	...
	//supports both xml configured fetch and  java code fetch for HQL
	@Override
