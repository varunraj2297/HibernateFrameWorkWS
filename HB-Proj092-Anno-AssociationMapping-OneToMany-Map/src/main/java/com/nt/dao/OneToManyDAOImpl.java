...
public class OneToManyDAOImpl  implements OneToManyDAO{
	...
	public void saveData() {
		...
		posts.put("post1",post1);     
		posts.put("post2",post2);
		posts.put("post3",post3);
	...
	public void loadData() {
		...
		blogStream.forEach(blog->{
		    ...
		    blog.getPosts().forEach((mapIndex,post)->{
		    	System.out.println("child::"+mapIndex+"  "+post);
		    });
		});
